<div class="col-12">
    <form class="p-5" enctype="multipart/form-data" wire:submit.prevent="store">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="banyaknya_barang">Banyaknya Barang Masuk <span style="color: red;">*</span> </label>
                <input wire:model="banyaknya_barang" type="number" class="form-control" id="banyaknya_barang" placeholder="">
            </div>
        </div>
        <hr>
